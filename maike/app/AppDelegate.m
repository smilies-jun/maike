...
- (void)setupViewControllers {
    ...
    UIViewController *secondViewController = [[YJShopViewController alloc] init];
    ...
    UIViewController *FourViewController = [[YJMyOrdwerViewController alloc] init];
...
- (void)customizeTabBarForController:(RDVTabBarController *)tabBarController {
    ...
    NSArray *tabBarItemImages = @[@"licai", @"huodong", @"more",@"more",@"more"];
    NSArray *tabBarItemNames = @[@"展厅", @"全部", @"工作台",@"订单",@"我的"];
    NSInteger index = 0;
